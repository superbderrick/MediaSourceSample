...
/**
 * [init setdatas url , video element to play  ]
 * @param  {[string]} url   [contents url]
 * @param  {[video element]} video [video element from html] 
 */
...
/**
 * [parseMPD parseMpddata to dash play]
 */
...
dashPlayer.getData = function(url) {
	...
	xhr.onreadystatechange = function () {
	  if (xhr.readyState == xhr.DONE) {
	    ...
	    // Get  the parameters of the .mpd file
...
dashPlayer.updateFunct = function() {
  console.log('dashPlayer.updateFunct');
...
dashPlayer.getStarted = function(url) {
  console.log('dashPlayer.getStarted');
  ...
  dashPlayer.video.addEventListener('canplay', dashPlayer.canPlayEvent);   
  dashPlayer.video.addEventListener('error', dashPlayer.showErrorMessage);  
}

dashPlayer.canPlayEvent = function () {
   console.log('canPlayEvent');
   dashPlayer.video.play();
}

dashPlayer.showErrorMessage = function () {
   console.log('showErrorMessage');
}


dashPlayer.playSegment = function(range , url) {
  console.log('dashPlayer.playSegment');
  console.log('dashPlayer.playSegment' + range);
  console.log('dashPlayer.playSegment' + url);
	   var xhr = new XMLHttpRequest();
...
dashPlayer.fileChecks = function() {
  console.log("dashPlayer.fileChecks");
